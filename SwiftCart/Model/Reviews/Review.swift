...
let dummyReviews: [Review] = [
    Review(reviewerName: "Ahmed Osman", reviewDescription: "This product is amazing! I love it.", reviewRating: 4.3),
    Review(reviewerName: "Anas Salah", reviewDescription: "Very good quality and fast shipping.", reviewRating: 4.7),
    Review(reviewerName: "Isra Muhammed", reviewDescription: "Not bad, but could be better.", reviewRating: 4.4),
    Review(reviewerName: "Elham", reviewDescription: "This product is amazing! Very satisfied.", reviewRating: 4.8),
    ...
    Review(reviewerName: "Eng.mohamed Galal", reviewDescription: "Decent product, good value for money.", reviewRating: 4.2),
    Review(reviewerName: "Eng/ Heba", reviewDescription: "The product was damaged upon arrival.", reviewRating: 1.5),
    Review(reviewerName: "Manal Hamada", reviewDescription: "Very satisfied with the product and service.", reviewRating: 4.8),
    ...
    Review(reviewerName: "Hadi", reviewDescription: "Fast shipping, but the product quality is poor.", reviewRating: 2.2),
    Review(reviewerName: "Eng/ Safia", reviewDescription: "Excellent service, good product quality.", reviewRating: 4.7),
    Review(reviewerName: "Abdo", reviewDescription: "Product arrived damaged, disappointed.", reviewRating: 1.0),
    Review(reviewerName: "Mahmoud Osama", reviewDescription: "Highly recommend this product. Very satisfied.", reviewRating: 5.2),
    Review(reviewerName: "Abdelrahman Sayed", reviewDescription: "Not as described. Disappointed with the product.", reviewRating: 2.1),
    Review(reviewerName: "Asmaa Mohamed", reviewDescription: "Impressed with the quality and delivery speed.", reviewRating: 4.7),
    Review(reviewerName: "Aya Mosrafa", reviewDescription: "Average product, nothing exceptional.", reviewRating: 3.1),
    Review(reviewerName: "Dr.Eman Hesham", reviewDescription: "Excellent product, exceeded expectations.", reviewRating: 5.3),
    ...
    Review(reviewerName: "Naden", reviewDescription: "Very satisfied with the purchase. Great product.", reviewRating: 4.7),
