...
struct FavCRUD {
    ...
    func isItemInFavorites(favId: Int, itemId: Int, completion: @escaping (Bool) -> Void) {
        readItems(favId: favId) { lineItems in
            let isFavorited = lineItems.contains { $0.id == itemId }
