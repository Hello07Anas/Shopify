...
final class SwiftCartTests: XCTestCase {
    ...
    func testGetAPIData_Fail() throws {
        // Arrange
        let endpoint = "products.json"
        let expectedProductId = 7680312049711
    ...
    func testDeleteAddressUnavailable () throws {
        _ = Address(
            id: 1,
        ...
        let endpoint = K.endPoints.putOrDeleteAddress.rawValue
            ...
            .replacingOccurrences(of: "{address_id}", with: "1")
    ...
    func testCannotDelete() throws {
            ...
            _ = observable
                .subscribe(onNext: { statusCode in
                    XCTFail("Expected Failer response, but got successful with: \(statusCode)")
                }, onError: { error in
                    XCTAssertTrue(true)
                    expectation.fulfill()
                })
